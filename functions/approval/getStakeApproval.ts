...
import { getStakeDepositAllowance } from 'functions/transactions/allowances';
import { Token } from 'types/assets';
import Web3 from 'web3';

export const getStakeApproval = async (
  asset: Token,
  chainId: number,
  web3: Web3,
  account: string,
  ...
  if (asset.address !== NATIVE_ADDRESS[chainId]) {
    assetAllowance = await getStakeDepositAllowance(
      web3,
      asset,
      account,
      chainId,
